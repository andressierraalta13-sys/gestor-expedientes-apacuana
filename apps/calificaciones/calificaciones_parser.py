...
MATERIA_MAP = {
    ...
    'A.C.T.':               'BIOLOGÍA, AMBIENTE Y TECNOLOGÍA',
    'ACT':                  'BIOLOGÍA, AMBIENTE Y TECNOLOGÍA',
    'BIOLOGIA':             'BIOLOGÍA, AMBIENTE Y TECNOLOGÍA',
    'AMBIENTE, CIENCIAS Y TECNOLOGIA': 'BIOLOGÍA, AMBIENTE Y TECNOLOGÍA',
    'FISICA':               'FÍSICA',
    'QUIMICA':              'QUÍMICA',
